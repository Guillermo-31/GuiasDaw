 ...
 * Descripción: Genera una tabla de multiplicar del número ingresado por el        *
 *              usuario, que debe ser un número entero entre 1 y 10                *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */

//INgresando el número y capturándolo usando el método prompt()
var numero = prompt('INgrese un número entero para obtener su tabla de multipicar','');

//Construyendo la tabla del número ingresado
document.write("<table>\n\t");
document.write("<caption>Tabla de multiplicar del "+numero+"</caption>\n");
