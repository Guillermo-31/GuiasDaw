function init(){
  ...
  //Creando el código que se insertará dentro del elemento div id=distribución
  var html = "<ul>\n\t<li>\n";
  ...
  //Recorrer todos los elementos a y asignar el manejador de evento mediante una función anónima
