...
var voto = 0;
var opcion=true;
var cont1=0; var cont2=0; var cont3=0;
var total = 0.0;
var per1 = 0.0, per2 = 0.0, per3 = 0.0;
...
//Obtener el porcentaje de la primera respuesta
per1 = Math.round((cont1/total) * Math.pow(10,2)/Math.pow(10,2));
//Obtener el porcentaje de la segunda respuesta
per2 = Math.round((cont2/total) * Math.pow(10,2)/Math.pow(10,2));
//Obtener el porcentaje de la tercera respuesta
